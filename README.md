...
6. Put·Away Process: The items are put away in their designated storage locations.
...
5. Quality Check: The quality of the heat·pressed items is checked.
   · Rework Needed: If rework is needed, the items are sent back for rework.
6. Packaging and Fulfillment: Heat·pressed items are packaged and fulfilled.
```mermaid
flowchart TD
